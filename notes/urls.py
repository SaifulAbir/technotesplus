...
from notes.api import TagListAPI, NoteCreateAPI, NoteUpdateDeleteAPI, NoteSearchAPI, NoteShareAPI, SharedNoteListAPI

urlpatterns = [
    path('note-search/', NoteSearchAPI.as_view(), name='note_search'),
    path('tag-list/', TagListAPI.as_view(), name='tag_list'),
    path('shared-note-list/', SharedNoteListAPI.as_view(), name='shared_note_list'),
